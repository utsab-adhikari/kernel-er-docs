      ...
      <header className="border-b border-neutral-800">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="space-x-6 text-sm text-neutral-300">
            ...
            <a
              href="https://github.com/utsab-adhikari/kernel-er"
              target="_blank"
            >
              GitHub
            </a>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:py-20">
        <div className="mb-16 sm:mb-20">
          ...
          <p className="max-w-2xl text-base text-neutral-300 sm:text-lg">
            kernel-er is a lifelong operating system & kernel engineering
            project. Every line of code is written with understanding — nothing
            copied, nothing rushed.
          </p>
        ...
        <div className="mb-16 sm:mb-20 grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-neutral-400">
              Git history reflects real learning over years, not tutorial
              speedruns.
            </p>
          </div>
