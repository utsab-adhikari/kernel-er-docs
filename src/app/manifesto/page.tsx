...
export default async function ReadmePage() {
  const mdSource ="https://github.com/utsab-adhikari/kernel-er/blob/main/manifesto.md";
  ...
  try {
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-16 text-sm text-red-400">
        Failed to load Manifesto markdown.
      ...
      <header className="mb-6 border-b border-neutral-800 pb-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <h1 className="text-lg font-semibold tracking-tight sm:text-2xl">
            ...
            <span className="text-neutral-100">Manifesto</span>
          </h1>
